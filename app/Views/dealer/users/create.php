...
<div class="d-flex justify-content-between align-items-start mb-3">
  <div>
    ...
    <div class="text-muted">Kendi bayiliğinize bağlı yeni kullanıcı oluşturun.</div>
  </div>

  <a href="<?= base_url('dealer/users') ?>" class="btn btn-outline-secondary">
...
<form action="<?= base_url('dealer/users') ?>" method="post">
  <?= csrf_field() ?>
  ...
  <div class="row g-3">
        ...
        <div class="card-body">
          ...
          <div class="row g-3">
            ...
            <div class="col-12 col-md-6">
              ...
              <div class="form-text">Dealer panelinden rol değiştirilemez.</div>
            </div>
    ...
    <div class="col-12 col-lg-4">
      ...
      <div class="d-flex justify-content-end gap-2 mt-3">
        <a href="<?= base_url('dealer/users') ?>" class="btn btn-outline-secondary">Vazgeç</a>
