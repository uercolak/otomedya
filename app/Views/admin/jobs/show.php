...
<div class="d-flex justify-content-between align-items-start mb-3">
  ...
  <div class="d-flex gap-2">
    <a class="btn btn-outline-secondary" href="<?= site_url('admin/jobs') ?>">Geri</a>

    <form method="post" action="<?= site_url('admin/jobs/' . (int)$job['id'] . '/retry') ?>">
      <button class="btn btn-outline-primary" type="submit">Tekrar Kuyruğa Al</button>
    </form>

    <form method="post" action="<?= site_url('admin/jobs/' . (int)$job['id'] . '/reset') ?>"
    ...
    <form method="post" action="<?= site_url('admin/jobs/' . (int)$job['id'] . '/cancel') ?>"
